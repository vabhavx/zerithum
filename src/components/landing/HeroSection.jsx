...
const HeroSection = () => {
  ...
  return (
    <div className="relative z-10 pt-28 md:pt-40 pb-8 md:pb-16">
      ...
      >
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-serif font-bold text-white tracking-tight leading-[1.1] text-center max-w-4xl">
          Know exactly where your money went.
        </h1>

        <p className="text-base md:text-xl text-zinc-400 max-w-2xl text-center leading-relaxed mt-6 md:mt-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-center w-full mt-8 md:mt-10">
          <Link to="/Signup">
            <Button
              size="lg"
        ...
        <div className="flex flex-wrap justify-center gap-4 md:gap-8 mt-10 text-[11px] md:text-xs text-zinc-500 font-mono uppercase tracking-wider">
