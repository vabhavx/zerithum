  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="text-lg font-bold text-foreground">Cashflow Forecast</h3>
          <p className="text-foreground/40 text-xs">Predicted payouts next 30 days</p>
        </div>
      </div>
      ...
      <div className="mb-4 p-4 rounded-lg bg-emerald-500/10 border border-emerald-500/20">
        ...
        <p className="text-2xl font-bold text-foreground">${totalExpected.toFixed(0)}</p>
          ...
          >
            <div className="flex items-center gap-3 flex-1">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-foreground text-sm font-medium capitalize">{pred.platform}</p>
