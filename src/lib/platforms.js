...
export const PLATFORMS = [
  ...
  },
  {
    ...
    description: "For eCommerce Brands: Sync complex store sales, order volumes, and multi-channel revenue.",
  ...
  },
  {
    ...
    description: "For Writers & Journalists: Import newsletter subscriptions and paid reader earnings.",
    requiresApiKey: true,
